	...
	<body class="app sidebar-mini dark-mode">
		...
		<!-- End Switcher -->
			...
			<!-- ROW-1 OPEN -->
                	...
                	{
						$category=mysqli_real_escape_string($con, htmlspecialchars($_POST['category'])); //get the name inputted on this field
						$content = mysqli_real_escape_string($con, htmlspecialchars($_POST['content'])); //to prevent xss attack
